...
export const MOCK_TAXI_STANDS: TaxiStand[] = [
  {
    id: 'stand-xiris',
    name: 'Base Taxis Crucero Xiris',
    locationName: 'Fray Junípero Serra esq. Morelos',
    coordinate: { latitude: 21.21780, longitude: -99.47060 },
    capacity: 6,
    activeTaxisCount: 3,
    phone: '4412960100',
  },
  {
    id: 'stand-jardin',
    name: 'Base Taxis Jardín Principal',
    locationName: 'Costado Presidencia Municipal / Misión Centro',
    coordinate: { latitude: 21.21830, longitude: -99.46880 },
    capacity: 8,
    activeTaxisCount: 4,
    phone: '4412960200',
  },
  {
    ...
    coordinate: { latitude: 21.21480, longitude: -99.47220 },
    capacity: 5,
    activeTaxisCount: 2,
    phone: '4412960300',
  },
